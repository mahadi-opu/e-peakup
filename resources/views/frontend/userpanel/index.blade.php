	  ...
	  <div class="row">
	    ...
	    <div class="col-lg-9">
	      ...
	      <div class="bg-light shadow-sm rounded pt-4">
	        <h3 class="text-5 font-weight-400 align-items-center px-4 mb-3">Recent Activity</h3>
	        <form class="pb-3" method="get" action="{{ route('userpanel_dashboard_index') }}">
	        	<div class="row">
	              <div class="col-md-4">
	        ...
	        <table class="table table-hover my-2">
	        	...
	        	<tbody>
		        	...
		        	@empty
		        		<tr>
		        			<td colspan="10"><div class="text-center text-danger">No data to show</div></td>
		        		</tr>
	        		@endforelse
	        	</tbody>	
	        </table>
...
@section('scripts')
	...
	<script type="text/javascript">
		...
		$('.userpanel_menu_dashboard').addClass('active');
	</script>
